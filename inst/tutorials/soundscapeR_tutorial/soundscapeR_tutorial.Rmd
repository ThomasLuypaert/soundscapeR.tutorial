...
figure_dir <- paste0(base::system.file("extdata", 
                           package = "soundscapeR.tutorial",
                           mustWork = TRUE), 
         "/images")

knitr::include_graphics(here::here(paste0(figure_dir, "/Step_1_data_collection.png")))
```
...
knitr::include_graphics(here::here(paste0(figure_dir, "/PAM_devices.png")))
```
...
knitr::include_graphics(here::here(paste0(figure_dir, "/PAM_case.png")))
```
...
knitr::include_graphics(here::here(paste0(figure_dir, "/PAM_batteries.jpg")))
```
...
knitr::include_graphics(here::here(paste0(figure_dir, "/PAM_SD.png")))
```
...
knitr::include_graphics(here::here(paste0(figure_dir, "/PAM_equipment_insert.png")))
```
...
knitr::include_graphics(here::here(paste0(figure_dir, "/PAM_AudioMoth_App_Total.png")))
```
...
knitr::include_graphics(here::here(paste0(figure_dir, "/acoustic_trait_space_total.png")))
```
$$\\[0.001in]$$
...
knitr::include_graphics(here::here(paste0(figure_dir, "/Step_3_OSUs.png")))
```
$$\\[0.001in]$$
...
knitr::include_graphics(here::here(paste0(figure_dir, "/Step_2_1_index_computation.png")))
```
$$\\[0.001in]$$
...
knitr::include_graphics(here::here(paste0(figure_dir, "/Step_2_2_index_computation.png")))
...
knitr::include_graphics(here::here(paste0(figure_dir, "/Step_4_binarization.png")))
```
$$\\[0.001in]$$
...
knitr::include_graphics(here::here(paste0(figure_dir, "/Step_5_relative_abundance.png")))
```
$$\\[0.001in]$$
...
figure_dir <- list.dirs(getwd())[grep("images", list.dirs(getwd()))][1]

knitr::include_graphics(here::here(paste0(figure_dir, "/Hill_numbers.png")))
```
\
...
knitr::include_graphics(here::here(paste0(figure_dir, "/Diversity_profile.png")))
```
$$\\[0.001in]$$
