...
\
If you're interested in the slide deck that accompanies this tutorial, you can find the slides on Part I: Collecting acoustic data using AudioMoth [here](https://docs.google.com/presentation/d/1u42EZRPJVxk1hHQiKCxqK2VJ4bP-ZLObOFvDajZf9zo/edit?usp=sharing), and the slides on Part II: A soundscape approach to analysing big acoustic data [here](https://docs.google.com/presentation/d/13xTOucQI4DPDWQnhJ2pYWqrXHzV0mu6LQm0ERheTXJI/edit?usp=sharing). 
